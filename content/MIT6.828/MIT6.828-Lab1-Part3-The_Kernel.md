...
tags: []
show_tags: true
created: Thursday, September 18th 2025, 4:47:05 pm
updated: Thursday, September 18th 2025, 5:16:22 pm
---
...
很多机器并没有 0xf0100000这个地址，所以需要通过处理器的内存管理硬件，借助内存管理技术(分段、分页)将这个地址映射到 `.text LMA=0x00100000 = 2^10 = 1M`，根据[[MIT6.828-Lab1-Part1-PC引导程序|PC引导程序]]的内存布局图片来看，此地址就在BIOS的正上方。
...
## [[MIT6.828-Lab1-Part3-Exercise7-跟踪JOS内核并理解|Exercise7]]:
...
## [[MIT6.828-Lab1-Part3-Exercise8-printf相关文档|Exercise8]]:

1. 缺省了一部分有关于使用 "%o" 来格式化八进制输出的代码，完善它。
2. 回答几个问题，具体见[[MIT6.828-Lab1-Part3-Exercise8-printf相关文档|此作业的博客]]
...
## [[MIT6.828-Lab1-Part3-Exercise9-内核如何控制堆栈空间|Exercise9]]:
...
## [[MIT6.828-Lab1-Part3-Exercise10-通过嵌套调用程序熟悉栈生长过程|Exercise10]]:
...
## [[MIT6.828-Lab1-Part3-Exercise11-完善mon_backtrace的代码|Exercise11]]:
...
## [[MIT6.828-Lab1-Part3-Exercise12-修改mon_backtrace的代码|Exercise12]]:
