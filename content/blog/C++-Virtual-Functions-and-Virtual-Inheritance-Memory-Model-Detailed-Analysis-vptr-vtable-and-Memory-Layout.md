---
title: C++虚函数与虚继承内存模型详解：vptr、vtable与内存布局
draft:
aliases: []
tags: []
created: 2025-09-16T15:24:40.4040+08:00
updated: 2025-10-12T16:18:36.3636+08:00
---
...
![image.png](https://cdn.jsdelivr.net/gh/hrxweb/obsidian-images/img/20250915183550264.png)

<font color =red>类 C 仅需要一个 vtable，因此只需要一个 vptr，整张虚表是根据继承的顺序线性的补充各函数指针（当然还有一些其他的信息也在虚表里）</font><font color =red>类 C 仅需要一个 vtable，因此只需要一个 vptr，整张虚表是根据继承的顺序线性的补充各函数指针（当然还有一些其他的信息也在虚表里）</font>
...
<img src="https://cdn.jsdelivr.net/gh/hrxweb/obsidian-images/img/20250915183642630.png
