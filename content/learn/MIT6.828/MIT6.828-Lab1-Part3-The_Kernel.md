...
tags: []
show_tags: true
created: 2025-09-18T16:47:05.055+08:00
...
很多机器并没有 0xf0100000这个地址，所以需要通过处理器的内存管理硬件，借助内存管理技术(分段、分页)将这个地址映射到 `.text LMA=0x00100000 = 2^10 = 1M`，根据[[MIT6.828-Lab1-Part1-PC-Boot-Program|PC引导程序]]的内存布局图片来看，此地址就在BIOS的正上方。
...
## [[MIT6.828-Lab1-Part3-Exercise7-Trace-and-Understand-JOS-Kernel|Exercise7]]:
...
1. `printf.c` 内有三个函数调用关系(a->b指b调用a)是：putch -> vcprintf -> cprintf，最终实现的功能是输出单个字符，另外：
   2. cputchar -> putch: 而 cputchar 被定义在 `console.c`
   3. vprintfmt -> vcprintf: 而 vprintfmt 被定义在 `printfmt.c`

用图来表示(没带参数的函数只是忽略没写，并不代表没有参数)：

![image.png](https://cdn.jsdelivr.net/gh/hrxweb/obsidian-images/img/20250918171620794.png)
...
## [[MIT6.828-Lab1-Part3-Exercise8-printf-Related-Documentation|Exercise8]]:

1. 缺省了一部分有关于使用 "%o" 来格式化八进制输出的代码，完善它。
2. 回答几个问题，具体见[[MIT6.828-Lab1-Part3-Exercise8-printf-Related-Documentation|此作业的博客]]
...
## [[MIT6.828-Lab1-Part3-Exercise9-How-Kernel-Controls-Stack-Space|Exercise9]]:
...
## [[MIT6.828-Lab1-Part3-Exercise10-Familiarize-with-Stack-Growth-through-Nested-Calls|Exercise10]]:
...
## [[MIT6.828-Lab1-Part3-Exercise11-Complete-mon-backtrace-Code|Exercise11]]:
...
## [[MIT6.828-Lab1-Part3-Exercise12-Modify-mon-backtrace-Code|Exercise12]]:
