---
title: 配置X11Forward显示远程图形界面
draft:
aliases: []
tags: []
created: 2025-09-24T16:54:25.2525+08:00
updated: 2025-12-24T14:57:26.2626+08:00
---
...
- **设置** `**DISPLAY**`: `sshd` 会自动将你的会话环境变量 `DISPLAY` 设置为 `localhost:10.0`（或者:11.0, :12.0 ...，通常从 10 开始）。这个 `DISPLAY` 指向的**并不是一个真正的 Xorg 进程，而是指向** `**sshd**` **自己开的那个代理端口**。
