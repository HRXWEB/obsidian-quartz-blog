...
updated: 2025-10-12T15:42:27.2727+08:00
---
...
A 需要依赖 B，但是 B 设置成 private 依赖 C 后，导致 A 找不到 C 相关的 api，静态编译阶段的 link 报错一大堆的 `undefined reference to`

## 各场景对应的解决方案

### 场景1：使用 INTERFACE 关键字
